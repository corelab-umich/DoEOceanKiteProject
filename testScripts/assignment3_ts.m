...
fpath = [pwd filesep 'outputs' filesep 'assignment3' filesep];%Save Path for simulations
...
%             el = asin(altitude/thrLength);                              %   rad - Initial elevation angle
            el = deg2rad(30);
            aoaSPDeg=12;% Constant AoA Setpoint in Degrees
            ...
            thr.numNodes.setValue(4 + thrLength/100,'');
            thr.tether1.numNodes.setValue(4 + thrLength/100,'');
            ...
            thr.tether1.dragCoeff.setValue(0.8,'');
            %%  Winches Properties
            %Initalize winch
