...
plot(speed1p0.tsc.netPower, 'DisplayName', "v = 1.0 m/s")
plot(speed1p25.tsc.netPower, 'DisplayName', "v = 1.25 m/s")
legend()
title("Mechanical Power vs Time")
xlabel("Time [s]")
ylabel("Mechanical Power [W]")
grid on
filename = fpath + "mechPower.fig";
saveas(gcf, filename)
...
figure;
hold on;
plot(speed0p75.tsc.alphaBdy, 'DisplayName', "v = 0.75 m/s")
plot(speed1p0.tsc.alphaBdy, 'DisplayName', "v = 1.0 m/s")
plot(speed1p25.tsc.alphaBdy, 'DisplayName', "v = 1.25 m/s")
legend()
title("AoA vs Time")
xlabel("Time [s]")
ylabel("AoA [rad]")
grid on
filename = fpath + "aoa.fig";
saveas(gcf, filename)
